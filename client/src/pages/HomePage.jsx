...
const HomePage = () => (
  ...
  >
    ...
    >
      ...
      <button className="mt-6 px-6 py-3 bg-secondary text-black rounded-lg text-lg font-semibold hover:bg-accent hover:shadow-xl transition transform hover:scale-105">
        Join the Team
      </button>
    </motion.div>
  </div>
